...
name_()
{
  transition_num_ = aux.get_Transitions_Num();
  ID_ = aux.get_ID();
 ...
 */
unsigned int State::get_Transitions_Num (void) const {
 ...
 */
void State::set_Transitions_Num (unsigned int n_transitions) {
...
State& State::operator = (const State& state2) {
  ...
  transition_num_ = state2.get_Transitions_Num();
  ID_ = state2.get_ID();
...
bool State::operator != (const State& state2) const {
  ...
  if (ID_ == state2.get_ID()  && transition_num_ == state2.get_Transitions_Num() && transitions_.size() == state2.get_Transitions().size())
